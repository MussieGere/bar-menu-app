...
app.get('/api/run-bulk-pizzas', async (req, res) => {
  try {
    ...
    const pizzas = [
      {
        tab: 'food',
        category: 'Pizze / Pizzas',
        name: 'Margherita',
        price: '€ 8,00',
        desc_it: 'pomodoro, mozzarella, olio d\'oliva, origano',
        desc_en: '<strong>EN:</strong> tomato sauce, mozzarella cheese, olive oil, oregano<br><strong>ES:</strong> salsa de tomate, queso mozzarella, aceite de oliva, orégano<br><strong>DE:</strong> Tomatensoße, Mozzarella, Olivenöl, Oregano<br><strong>FR:</strong> sauce tomate, mozzarella, huile d\'olive, origan',
        isVegetarian: true, isVegan: false, isGlutenFree: false, available: true
      },
      {
        tab: 'food', category: 'Pizze / Pizzas', name: 'Capricciosa', price: '€ 12,00',
        desc_it: 'pomodoro, mozzarella, funghi, prosciutto cotto, uovo, olio d\'oliva, origano',
        desc_en: '<strong>EN:</strong> tomato sauce, mozzarella cheese, mushrooms, ham, boiled egg, olive oil, oregano<br><strong>ES:</strong> salsa de tomate, queso mozzarella, champiñones, jamón cocido, huevo cocido, aceite de oliva, orégano<br><strong>DE:</strong> Tomatensoße, Mozzarella, Champignons, Kochschinken, gekochtes Ei, Olivenöl, Oregano<br><strong>FR:</strong> sauce tomate, mozzarella, champignons, jambon blanc, œuf dur, huile d\'olive, origan',
        isVegetarian: false, isVegan: false, isGlutenFree: false, available: true
      },
      {
        tab: 'food', category: 'Pizze / Pizzas', name: 'Vegetariana', price: '€ 12,50',
        desc_it: 'mozzarella, funghi, spinaci, zucchine, melanzane grigliate, olio d\'oliva, origano',
        desc_en: '<strong>EN:</strong> mozzarella cheese, mushrooms, spinach, grilled zucchini, eggplants, olive oil, oregano<br><strong>ES:</strong> queso mozzarella, champiñones, espinacas, calabacín asado, berenjenas asadas, aceite de oliva, orégano<br><strong>DE:</strong> Mozzarella, Champignons, Spinat, gegrillte Zucchini, Auberginen, Olivenöl, Oregano<br><strong>FR:</strong> mozzarella, champignons, épinards, courgettes grillées, aubergines grillées, huile d\'olive, origan',
        isVegetarian: true, isVegan: false, isGlutenFree: false, available: true
      },
      {
        tab: 'food', category: 'Pizze / Pizzas', name: 'Ai Paladini', price: '€ 12,50',
        desc_it: 'pomodoro, mozzarella, crudo, burrata, olio d\'oliva, origano',
        desc_en: '<strong>EN:</strong> tomato sauce, mozzarella cheese, Parma ham, burrata cheese, olive oil, oregano<br><strong>ES:</strong> salsa de tomate, queso mozzarella, jamón de Parma, queso burrata, aceite de oliva, orégano<br><strong>DE:</strong> Tomatensoße, Mozzarella, Parmaschinken, Burrata-Käse, Olivenöl, Oregano<br><strong>FR:</strong> sauce tomate, mozzarella, jambon de Parme, burrata, huile d\'olive, origan',
        isVegetarian: false, isVegan: false, isGlutenFree: false, available: true
      },
      {
        tab: 'food', category: 'Pizze / Pizzas', name: 'Norma', price: '€ 12,50',
        desc_it: 'pomodoro, mozzarella, melanzane fritte, ricotta salata, basilico, olio d\'oliva, origano',
        desc_en: '<strong>EN:</strong> tomato sauce, mozzarella cheese, fried eggplants, dried ricotta cheese, basil, olive oil, oregano<br><strong>ES:</strong> salsa de tomate, queso mozzarella, berenjenas fritas, queso ricotta salado, albahaca, aceite de oliva, orégano<br><strong>DE:</strong> Tomatensoße, Mozzarella, gebratene Auberginen, gesalzener Ricotta, Basilikum, Olivenöl, Oregano<br><strong>FR:</strong> sauce tomate, mozzarella, aubergines frites, ricotta salée, basilic, huile d\'olive, origan',
        isVegetarian: true, isVegan: false, isGlutenFree: false, available: true
      },
      {
        tab: 'food', category: 'Pizze / Pizzas', name: 'Diavola', price: '€ 12,00',
        desc_it: 'pomodoro, mozzarella, cipolla, salame piccante, olive nere, olio d\'oliva, origano',
        desc_en: '<strong>EN:</strong> tomato sauce, mozzarella cheese, onion, spicy salami, black olives, olive oil, oregano<br><strong>ES:</strong> salsa de tomate, queso mozzarella, cebolla, salami picante, aceitunas negras, aceite de oliva, orégano<br><strong>DE:</strong> Tomatensoße, Mozzarella, Zwiebeln, scharfe Salami, schwarze Oliven, Olivenöl, Oregano<br><strong>FR:</strong> sauce tomate, mozzarella, oignon, salami piquant, olives noires, huile d\'olive, origan',
        isVegetarian: false, isVegan: false, isGlutenFree: false, available: true
      },
      {
        tab: 'food', category: 'Pizze / Pizzas', name: 'Siciliana', price: '€ 12,00',
        desc_it: 'pomodoro, mozzarella, acciughe, capperi, cipolla, olive nere, olio d\'oliva, origano',
        desc_en: '<strong>EN:</strong> tomato sauce, mozzarella cheese, anchovies, capers, onion, black olives, olive oil, oregano<br><strong>ES:</strong> salsa de tomate, queso mozzarella, anchoas, alcaparras, cebolla, aceitunas negras, aceite de oliva, orégano<br><strong>DE:</strong> Tomatensoße, Mozzarella, Sardellen, Kapern, Zwiebeln, schwarze Oliven, Olivenöl, Oregano<br><strong>FR:</strong> sauce tomate, mozzarella, anchois, câpres, oignon, olives noires, huile d\'olive, origan',
        isVegetarian: false, isVegan: false, isGlutenFree: false, available: true
      },
      {
        tab: 'food', category: 'Pizze / Pizzas', name: 'Vulcano', price: '€ 14,00',
        desc_it: 'mozzarella di bufala, funghi, salsiccia, olive nere, cipolla, grana, olio d\'oliva, origano',
        desc_en: '<strong>EN:</strong> buffalo\'s mozzarella cheese, mushrooms, sausage, black olives, onion, slivers of parmesan, olive oil, oregano<br><strong>ES:</strong> queso mozzarella de búfala, champiñones, salchicha, aceitunas negras, cebolla, lascas de parmesano, aceite de oliva, orégano<br><strong>DE:</strong> Büffelmozzarella, Champignons, Wurst, schwarze Oliven, Zwiebeln, Parmesansplitter, Olivenöl, Oregano<br><strong>FR:</strong> mozzarella de bufflonne, champignons, saucisse, olives noires, oignon, copeaux de parmesan, huile d\'olive, origan',
        isVegetarian: false, isVegan: false, isGlutenFree: false, available: true
      },
      {
        tab: 'food', category: 'Pizze / Pizzas', name: 'Isola Bella', price: '€ 14,00',
        desc_it: 'mozzarella di bufala, pomodorini, prosciutto crudo, rucola, grana, olio d\'oliva, origano',
        desc_en: '<strong>EN:</strong> buffalo\'s mozzarella cheese, cherry tomatoes, Parma ham, rocket plant, slivers of parmesan, olive oil, oregano<br><strong>ES:</strong> queso mozzarella de búfala, tomates cherry, jamón de Parma, rúcula, lascas de parmesano, aceite de oliva, orégano<br><strong>DE:</strong> Büffelmozzarella, Kirschtomaten, Parmaschinken, Rucola, Parmesansplitter, Olivenöl, Oregano<br><strong>FR:</strong> mozzarella de bufflonne, tomates cerises, jambon de Parme, roquette, copeaux de parmesan, huile d\'olive, origan',
        isVegetarian: false, isVegan: false, isGlutenFree: false, available: true
      },
      {
        tab: 'food', category: 'Pizze / Pizzas', name: 'Pistacchio', price: '€ 15,00',
        desc_it: 'mozzarella, guanciale, pistacchio, olio, origano',
        desc_en: '<strong>EN:</strong> mozzarella cheese, bacon, pistachio, olive oil, oregano<br><strong>ES:</strong> queso mozzarella, tocino (guanciale), pistacho, aceite de oliva, orégano<br><strong>DE:</strong> Mozzarella, Speck (Guanciale), Pistazien, Olivenöl, Oregano<br><strong>FR:</strong> mozzarella, lard (guanciale), pistache, huile d\'olive, origan',
        isVegetarian: false, isVegan: false, isGlutenFree: false, available: true
      },
      {
        tab: 'food', category: 'Pizze / Pizzas', name: 'Gustosa', price: '€ 15,00',
        desc_it: 'pomodoro, mozzarella, cipolla, olive nere, tonno, olio d\'oliva, origano',
        desc_en: '<strong>EN:</strong> tomato sauce, mozzarella cheese, onion, black olives, tuna, olive oil, oregano<br><strong>ES:</strong> salsa de tomate, queso mozzarella, cebolla, aceitunas negras, atún, aceite de oliva, orégano<br><strong>DE:</strong> Tomatensoße, Mozzarella, Zwiebeln, schwarze Oliven, Thunfisch, Olivenöl, Oregano<br><strong>FR:</strong> sauce tomate, mozzarella, oignon, olives noires, thon, huile d\'olive, origan',
        isVegetarian: false, isVegan: false, isGlutenFree: false, available: true
      },
      {
        tab: 'food', category: 'Pizze / Pizzas', name: 'Boscaiola', price: '€ 12,50',
        desc_it: 'pomodoro, mozzarella, funghi, salsiccia, cipolla, olio d\'oliva, origano',
        desc_en: '<strong>EN:</strong> tomato sauce, mozzarella cheese, mushrooms, sausage, onion, olive oil, oregano<br><strong>ES:</strong> salsa de tomate, queso mozzarella, champiñones, salchicha, cebolla, aceite de oliva, orégano<br><strong>DE:</strong> Tomatensoße, Mozzarella, Champignons, Wurst, Zwiebeln, Olivenöl, Oregano<br><strong>FR:</strong> sauce tomate, mozzarella, champignons, saucisse, oignon, huile d\'olive, origan',
        isVegetarian: false, isVegan: false, isGlutenFree: false, available: true
      },
      {
        tab: 'food', category: 'Pizze / Pizzas', name: 'Acciughe e Burrata', price: '€ 13,00',
        desc_it: 'pomodoro, acciughe, burrata, olio, origano',
        desc_en: '<strong>EN:</strong> tomato sauce, anchovies, burrata cheese, olive oil, oregano<br><strong>ES:</strong> salsa de tomate, anchoas, queso burrata, aceite de oliva, orégano<br><strong>DE:</strong> Tomatensoße, Sardellen, Burrata-Käse, Olivenöl, Oregano<br><strong>FR:</strong> sauce tomate, anchois, burrata, huile d\'olive, origan',
        isVegetarian: false, isVegan: false, isGlutenFree: false, available: true
      }
    ];
    ...
    for (let p of pizzas) {
      // Look for an existing pizza by its exact name
      const existing = await MenuItem.findOne({ name: p.name, category: 'Pizze / Pizzas' });
      
      if (existing) {
        // If it exists, update it with the new translations!
        ...
        await new MenuItem(p).save();
        createdCount++;
      }
    }

    res.send(`<h1>✅ Success!</h1><p>Updated ${updatedCount} existing pizzas.</p><p>Created ${createdCount} new pizzas.</p><p>You can now delete this script from server.js.</p>`);
  } catch (err) {
    console.error(err);
